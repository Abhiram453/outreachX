...
function FeatureCard({ icon, title, description, delay }) {
  return (
    <motion.div
      ...
      className="rounded-2xl p-6 cursor-pointer group transition-all bg-white/80 border border-blue-100 backdrop-blur-xl shadow-lg"
    >
      <div className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform bg-gradient-to-br from-blue-500 to-sky-400">
        {icon}
      </div>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden transition-colors duration-300 bg-gradient-to-br from-blue-50 via-white to-sky-50 text-gray-800">
      <BackgroundOrbs />
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-br from-blue-500 to-sky-400">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="transition-colors text-gray-600 hover:text-blue-600">Features</a>
            <a href="#how-it-works" className="transition-colors text-gray-600 hover:text-blue-600">How it Works</a>
          </div>
          
          <div className="flex items-center gap-4">
            <Link href="/login" className="transition-colors hidden sm:block text-gray-600 hover:text-blue-600">
              Sign In
            </Link>
            <Link
              href="/signup"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl max-w-xl mb-8 text-gray-600">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    href="/signup"
                    className="px-8 py-4 rounded-xl font-semibold text-lg inline-flex items-center gap-2 text-white bg-gradient-to-r from-blue-500 to-sky-400 hover:from-blue-600 hover:to-sky-500"
                  >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    href="#features"
                    className="px-8 py-4 rounded-xl font-semibold text-lg inline-flex items-center gap-2 border transition-colors border-blue-200 text-gray-700 hover:bg-blue-50"
                  >
                    Explore Features
                  </Link>
                </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="rounded-2xl p-8 text-center h-full bg-white/80 border border-blue-100 backdrop-blur-xl shadow-lg">
                  <div className="text-6xl font-bold absolute top-4 right-4 text-blue-500/20">
                    {item.step}
                  </div>
                  <div className="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center text-4xl mb-6 bg-gradient-to-br from-blue-500 to-sky-400">
                    {item.icon}
                  </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-3xl p-12 text-center relative overflow-hidden bg-white/80 border border-blue-100 backdrop-blur-xl shadow-lg"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-sky-400/10"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8 text-sm text-gray-600">
              <a href="#" className="transition-colors hover:text-blue-600">Privacy</a>
              <a href="#" className="transition-colors hover:text-blue-600">Terms</a>
              <a href="#" className="transition-colors hover:text-blue-600">Contact</a>
            </div>
            <p className="text-sm text-gray-500">© 2026 OutreachX. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
